...
- The selected-window capture validator is preparation only. Until runtime evidence is recorded, it does not change the central `60 passed, 0 failed, 0 pending` smoke count or release readiness.
